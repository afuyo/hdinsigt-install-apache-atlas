...
#scp apache-atlas-0.9-incubating-SNAPSHOT-bin.tar.gz sshuser@hbasesolr03-ssh.azurehdinsight.net:/tmp

cd /usr/hdp/current
sudo mv /tmp/kafka_2.11-0.11.0.0.tgz .
sudo mv /tmp/apache-atlas-0.9-incubating-SNAPSHOT-bin.tar.gz .
sudo mv /tmp/solr-5.2.1.tgz .

sudo tar -xzvf apache-atlas-0.9-incubating-SNAPSHOT-bin.tar.gz 
...
sudo rm -f /tmp/apache-atlas-0.9-incubating-SNAPSHOT-bin.tar.gz 
...
cd /usr/hdp/current/apache-atlas-0.9-incubating-SNAPSHOT/conf
...
#setup kafka topics
cd /usr/hdp/current/apache-atlas-0.9-incubating-SNAPSHOT/bin
...
#start atlas
cd /usr/hdp/current/apache-atlas-0.9-incubating-SNAPSHOT/
